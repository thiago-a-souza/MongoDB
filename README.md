...
Initially, transactions were supported only at the document level, in other words, ACID properties were guaranteed only within fields of the same document. Starting in version 4.0, MongoDB also supports multi-document transactions at a high performance cost. 
